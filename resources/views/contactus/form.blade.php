<div class="card">
    ...
    <div class="card-body">
        ...
        <div id="pay-invoice">
            <div class="card-body">
            @if(isset($policy))
                {{ Form::open(array('url'=>'web-management/contactUs/'.$policy->id , 'method' => 'PATCH', 'enctype'=> 'multipart/form-data')) }}
            @else
                {{ Form::open(array('url'=>'web-management/contactUs' , 'method'=>'POST' , 'enctype'=> 'multipart/form-data')) }}
            @endif            
                    @if ($errors->any())
