                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="_name" name="_name" type="text" class="form-control hashtag" value="{{ isset($leagues) ? $leagues->_name : '' }}" placeholder="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                @if(isset($leagues))
                                    <option value="1" {{ $leagues->_active == '1' ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ $leagues->_active == '0' ? 'selected' : '' }}>No</option>
                                @else
